const Header = () => {
    ...
    return (
        <div className="p-4 border-b-2 grid grid-flow-col">
            <div className="col-span-11">
                <input className="rounded-lg p-2 bg-slate-100" placeholder="Search"></input>
            </div>
            <div className="flex col-span-1 m-auto cursor-pointer">
                ...
                <div class="ai s" className="ml-1">Write</div>
            </div>
            <div class="relative col-span-1 inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
